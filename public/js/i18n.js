...
const MESSAGES = {
  en: {
    ...
    'solo.boardTitle': 'Fastest escapes',
    'solo.boardNote': 'Every room is generated fresh, so no two runs are quite alike — bragging rights, not a fair race.',
    'solo.boardEmpty': 'Nobody has escaped yet. Be the first.',
    'ui.theme': 'Day / night',
  ...
  es: {
    ...
    'solo.boardTitle': 'Escapes más rápidos',
    'solo.boardNote': 'Cada sala se genera de nuevo, así que no hay dos partidas iguales — es para presumir, no una carrera justa.',
    'solo.boardEmpty': 'Todavía no ha escapado nadie. Sé el primero.',
    'ui.theme': 'Día / noche',
    'ui.language': 'Idioma',
  ...
  pt: {
    ...
    'solo.boardTitle': 'Fugas mais rápidas',
    'solo.boardNote': 'Cada sala é gerada na hora, então não há duas partidas iguais — é para se gabar, não uma corrida justa.',
    'solo.boardEmpty': 'Ninguém escapou ainda. Seja o primeiro.',
    'ui.theme': 'Dia / noite',
    'ui.language': 'Idioma',
    'team.default1': 'Pistas Falsas',
